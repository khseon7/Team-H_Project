...
class HotPlaces(models.Model):
    ...
    rating=models.DecimalField(max_digits=1,decimal_places=1,validators=[validate_rating],default=0.0)
...
class Review(models.Model):
    ...
    rating=models.DecimalField(max_digits=1,decimal_places=1,validators=[validate_rating])
